...
# 但实际的嵌套注册会在 skillforge_django/urls.py 中进行。
...
# 如果我们希望在 skillforge_django/urls.py 中使用 include('testcases.urls')
...
# 2. skillforge_django/urls.py (或 projects/urls.py 如果项目路由在那里定义)
