...
v1.4.0 版本重点增强了 AI 智能交互能力和自动化测试生态。新版本引入了 Playwright 浏览器自动化工具，赋予了 AI 更强大的浏览器操作能力；新增了 AI 智能安装助手，大幅简化了部署流程；强化了 LangGraph 代理接口，优化了前端交互体验。同时，在项目管理、Dashboard 展示及系统文档方面也进行了全方位升级，进一步提升了平台的易用性和稳定性。
