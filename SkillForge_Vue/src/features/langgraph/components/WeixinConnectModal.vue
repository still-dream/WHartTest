...
const text = computed(() => (
  isEnglish.value
    ? {
        ...
        heroDescription: 'After scanning the code, users can chat in WeChat with the SkillForge session for this project.',
        boundCount: 'Bound',
    ...
    : {
        ...
        heroDescription: '扫码后，用户可以直接在微信里与当前项目对应的 SkillForge 会话沟通，消息仍然走你现有的对话链路。',
        boundCount: '已绑定',
        runningCount: '运行中',
        errorCount: '异常',
        generateQr: '生成二维码',
